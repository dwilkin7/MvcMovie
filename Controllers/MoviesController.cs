...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        public async Task<IActionResult> Index(string searchString, string sortBy) //parameter had 'string movieGenre'
        {
            ...
            //ViewData["DateSortParm"] = String.IsNullOrEmpty(sortBy) ? "releaseDate" : "";
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            //was FindAsyn instead of SingleOrDefaultAsync(m => m.Id == id);
